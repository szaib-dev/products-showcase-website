...
function GridRoundSquare({ products, limit }: GridRoundSquareProps) {
      ...
      {displayedProducts.map((product) => (
        ...
        >
          ...
          <div className="space-y-1 px-1">
            <h3 className="text-sm md:text-base font-bold text-gray-900 leading-tight tracking-tight line-clamp-2 group-hover:text-black">
              {product.name}
            </h3>
